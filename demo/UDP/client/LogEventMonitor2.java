 ...
 */
public class LogEventMonitor2 {

    private final EventLoopGroup group;
    private final Bootstrap bootstrap;


    public LogEventMonitor2(InetSocketAddress address) {
    ...
    public static void main(String[] args) {
        LogEventMonitor2 logEventMonitor = new LogEventMonitor2(new InetSocketAddress(7777));
